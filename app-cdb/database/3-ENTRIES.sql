...
insert into user(id, username, password, enabled) values (1, 'admin','$2y$10$kQHbosRFwwLsUjeOtPhKAunRXN2t9ZpFmbTGpMxosY8m9qJuddlbS', true);
insert into user(id, username, password, enabled) values (2, 'user','$2y$10$kQHbosRFwwLsUjeOtPhKAunRXN2t9ZpFmbTGpMxosY8m9qJuddlbS', true);
insert into role (user_id, role) values (1, 'USER');
