...
//
//import static fr.excilys.cdb.helper.HelperFront.getPageDto;
...
//		if (page.isPresent()) {
//			PageDto<Computer> computers = computerService.getComputersWithPage(page.get());
//			printList(computers.getContent(), NO_COMPUTERS);
//		}
//	}
//
//	public static PageDto<Computer> askPage() {
...
//		PageDto<Computer> page = getPageDto(numberPage, sizePage);
//		return page
//	}
//
